        ...
        <div class="modal-body ">
            <div class="border" style="padding: 8px;">
                ...
                <div class="row mb-4">
                    ...
                    <label class="col-sm-1">-</label>
                    <div class="col-sm-8">
                        <img src="{{ asset('assets/customer_details/proofimage_one/' .$bookingDatas['proofimage_one']) }}" style="width: 200px !important; height: 150px !important;"/>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <label class="col-sm-1">-</label>
                    <div class="col-sm-8">
                        <img src="{{ asset('assets/customer_details/proofimage_two/' .$bookingDatas['proofimage_two']) }}" style="width: 200px !important; height: 150px !important;"/>
                    </div>
                </div>
                <div class="row mb-4">
                    ...
                    <label class="col-sm-1">-</label>
                    <div class="col-sm-8">
                        <img src="{{ asset('assets/customer_details/customer_photo/' .$bookingDatas['customer_photo']) }}" style="width: 200px !important; height: 150px !important;"/>
                    </div>
                </div>
            </div>
        </div>
